import svgPaths from "./svg-7l4cbkosw8";
...
function NavTopAppBar() {
  return (
    <div className="bg-[#fbf9f3] drop-shadow-[0px_4px_5px_rgba(66,71,78,0.4)] h-[88px] relative rounded-[8px] shrink-0 w-full" data-name="Nav - TopAppBar">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center justify-between px-[16px] py-[32px] relative size-full">
          <TopContainer />
        </div>
      </div>
    </div>
...
function NavTopAppBar1() {
  return (
    <div className="bg-[#fbf9f3] drop-shadow-[0px_4px_5px_rgba(66,71,78,0.4)] relative rounded-[8px] shrink-0 w-full" data-name="Nav - TopAppBar">
