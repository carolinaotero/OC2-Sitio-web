import svgPaths from "./svg-zf10oqzyqe";
...
export default function TopNavBar() {
  return (
    <div className="bg-[rgba(0,0,0,0)] content-stretch flex items-center justify-between p-[32px] relative rounded-[8px] size-full" data-name="Top NavBar">
      <Container />
      <Container1 />
