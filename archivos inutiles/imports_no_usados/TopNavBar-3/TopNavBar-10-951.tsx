import svgPaths from "./svg-8cd27bziz4";
...
export default function TopNavBar() {
  return (
    <div className="content-stretch flex items-center justify-between px-[16px] py-[32px] relative rounded-[8px] size-full" data-name="Top NavBar">
      <Container />
