import svgPaths from "./svg-vetdd6ehid";
...
export default function TopNavBar() {
  return (
    <div className="bg-[rgba(0,0,0,0)] content-stretch flex items-center justify-between px-[16px] py-[32px] relative rounded-[8px] size-full" data-name="Top NavBar">
      <Container />
